...
ROCKSDB_PATH = os.environ.get("ROCKSDB_PATH", "ledger.rocksdb")  # Updated to RocksDB
...
TREASURY_ADDRESS = "bqs1ActualTreasuryAddressHere"
TREASURY_FEE_PERCENTAGE = Decimal('0.001')